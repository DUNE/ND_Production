...
export ND_PRODUCTION_LOGDIR_BASE="/pscratch/sd/a/abooth/MicroProdN3p4/logs"
export ND_PRODUCTION_OUTDIR_BASE="/pscratch/sd/a/abooth/MicroProdN3p4/output"

export ND_PRODUCTION_COMPRESS="gzip"
export ND_PRODUCTION_IN_NAME="MicroProdN3p4_NDLAr_2E18_FHC.larnd.geomfix.singles.nu"
export ND_PRODUCTION_OUT_NAME="MicroProdN3p4_NDLAr_2E18_FHC.flow.geomfix.singles.nu.v251016"

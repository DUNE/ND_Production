...
./GENIE_max_path_length_gen.sh /dvs_ro/cfs/cdirs/dune/users/abooth/gdml/anti_fiducial_nd_hall_with_lar_tms_sand_TDR_Production_geometry_v_1.0.3.gdml $tune

...
export TWOBYTWO_SIM="$BASE_DIR/ND_Production"
...
export ARCUBE_XSEC_FILE="/storage/gpfs_data/neutrino/users/gsantoni/ND_Production/run-genie/XSEC/SAND_opt2.xsec.14.xml" # si fermerà qui perchè il container ha genie 3.04.00 e queste sono con 3.04.02

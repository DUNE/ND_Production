...
export ND_PRODUCTION_DET_LOCATION='ProtoDUNE-ND-Rock'
...
export ND_PRODUCTION_GEOM='geometry/Merged2x2MINERvA_v2/Merged2x2MINERvA_v2_justRock.gdml'
...
export ND_PRODUCTION_OUT_NAME='test_Singularity.rock'

...
# Assumes ND_PRODUCTION_RUNTIME, ND_PRODUCTION_CONTAINER & ND_PRODUCTION_DIR have already been set
...
export ND_PRODUCTION_PANDORA_PFA_VERSION=v04-09-00
export ND_PRODUCTION_PANDORA_SDK_VERSION=v03-04-01
export ND_PRODUCTION_PANDORA_MONITORING_VERSION=v03-06-00
export ND_PRODUCTION_PANDORA_LAR_CONTENT_VERSION=v04_11_00
export ND_PRODUCTION_PANDORA_LAR_MLDATA_VERSION=v04-09-00
export ND_PRODUCTION_PANDORA_LAR_RECO_ND_VERSION=v01-01-04

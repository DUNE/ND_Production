...
ND_PRODUCTION_OUTDIR_BASE="/pscratch/sd/a/abooth/MiniProdN1p1-v1r1"
CAMPAIGN="MiniProdN1p1_NDLAr_1E19_RHC"
GEOMETRY="nd_hall_with_lar_tms_sand"
HORN="rhc"
TOPVOL="volArgonCubeDetector75+rockbox"

#./dump_metadata.py --all ${ND_PRODUCTION_OUTDIR_BASE}/ --app run-spill-build --campaign ${CAMPAIGN} --geom ${GEOMETRY} --top-vol ${TOPVOL} --horn-current ${HORN}

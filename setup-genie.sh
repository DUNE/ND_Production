...
export ND_PRODUCTION_OUTDIR_BASE=$ND_PRODUCTION_DIR/productions-prova-debug
export ND_PRODUCTION_LOGDIR_BASE=$ND_PRODUCTION_DIR/log-prova-debug
...
export ND_PRODUCTION_EXPOSURE=1000
